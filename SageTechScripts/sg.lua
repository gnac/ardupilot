...
local SG_MSG_LEN_INSTALL       =     41
local SG_MSG_LEN_FLIGHT        =     17
local SG_MSG_LEN_OPMSG         =     17
local SG_MSG_LEN_GPS           =     68
local SG_MSG_LEN_DATAREQ       =     9
local SG_MSG_LEN_TARGETREQ     =     12
local SG_MSG_LEN_MODE          =     10

-- Host Message Types
local SG_MSG_TYPE_HOST_INSTALL   =   0x01
local SG_MSG_TYPE_HOST_FLIGHT    =   0x02
local SG_MSG_TYPE_HOST_OPMSG     =   0x03
local SG_MSG_TYPE_HOST_GPS       =   0x04
local SG_MSG_TYPE_HOST_DATAREQ   =   0x05
local SG_MSG_TYPE_HOST_TARGETREQ =   0x0B
local SG_MSG_TYPE_HOST_MODE      =   0x0C

-- XPNDR Message Types
local SG_MSG_TYPE_XPNDR_ACK       =  0x80
local SG_MSG_TYPE_XPNDR_INSTALL   =  0x81
local SG_MSG_TYPE_XPNDR_FLIGHT    =  0x82
local SG_MSG_TYPE_XPNDR_STATUS    =  0x83
local SG_MSG_TYPE_XPNDR_COMMA     =  0x85
local SG_MSG_TYPE_XPNDR_MODE      =  0x8C
local SG_MSG_TYPE_XPNDR_VERSION   =  0x8E
local SG_MSG_TYPE_XPNDR_SERIALNUM =  0x8F

-- ADS-B Message Types
local SG_MSG_TYPE_ADSB_TSUMMARY   =   0x90
local SG_MSG_TYPE_ADSB_SVR        =   0x91
local SG_MSG_TYPE_ADSB_MSR        =   0x92
local SG_MSG_TYPE_ADSB_TSTATE     =   0x97
local SG_MSG_TYPE_ADSB_ARVR       =   0x98

-- Start byte for all host messages
local SG_MSG_START_BYTE           =   0xAA

-- Emitter category set byte values
local SG_EMIT_GROUP_A             =   0x00
local SG_EMIT_GROUP_B             =   0x01
local SG_EMIT_GROUP_C             =   0x02
local SG_EMIT_GROUP_D             =   0x03

-- Emitter category enumeration offsets
local SG_EMIT_OFFSET_A            =   0x00
local SG_EMIT_OFFSET_B            =   0x10
local SG_EMIT_OFFSET_C            =   0x20
local SG_EMIT_OFFSET_D            =   0x30
